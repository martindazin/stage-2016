<?php
	...
	if(file_exists($cheminDuFichier)) {
    	...
    	if ($last_newsletter_showed_id == ''){
			$last_newsletter_showed_id = 1;
		} else {
			$last_newsletter_showed_id = $last_newsletter_showed_id + 1;
		}
		...
		$newsletterAffichage = '<img src="'.esc_url(home_url('/')).'wp-content/plugins/atm_newsletter_md/tracking/trackingpixel.php" alt="" />'; 

		// Affiche de "Si ce message ne s'affiche pas correctement, cliquez-ici."
		$newsletterAffichage .= '<h5><hr style="height: 1px; color:'.$newsletterCouleurs[1].'; background-color:'.$newsletterCouleurs[1].'; border: none;"><a target="_blank" style="text-decoration:none; color:'.$newsletterCouleurs[0].';" href="'.esc_url(home_url('/'))."wp-content/plugins/atm_newsletter_md/newsletterNav.php?id=".$last_newsletter_showed_id."&status=T".'" title="">'."Si ce message ne s'affiche pas correctement, cliquez-ici.".'</a><hr style="height: 1px; color:'.$newsletterCouleurs[1].'; background-color:'.$newsletterCouleurs[1].'; border: none;"></h5>';
