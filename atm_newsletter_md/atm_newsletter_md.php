<?php
	...
	*/
	...
	function atm_newsletter_register_submenu_pages() {
		...
		add_submenu_page('atm_newsletter', __('Import/Gestion des Abonnés'), __('Import/Gestion des Abonnés'), 'edit_themes', 'atm_newsletter_abonnes', 'atm_newsletter_printSubsIndex');
	...
	// Affichage du menu "Import/Gestion des Abonnés"
