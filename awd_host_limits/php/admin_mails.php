...
<div class="wrap">
	...
	<div id="poststuff">
		<div class="postbox">
			<h3 class="hndle">
				Le formulaire permettant d'ajouter un client pour l'Espace Email
				se trouve <a href="http://www.atmospherecommunication.fr/wp-admin/admin.php?page=awd_host_limits_awd">ici</a>
			</h3>
			<!-- <div class="inside">
		...
		<h1>Liste des clients - Espace mail</h1>
		<div class="api_table">
			<?php 
				...
				// Permet d'afficher les intitulés de lignes ainsi que les lignes dans un tableau
				if( isset($_POST['s']) ){
		        	$wp_list_table->prepare_items_emails($_POST['s']);
		        } else {
		        	$wp_list_table->prepare_items_emails();
		        }
...
<script>
	...
	jQuery(function($){
		...
		// Edition d'une information du tableau
			// Permet d'avoir les boutons Modifier et Annuler pour chaque case du tableau
